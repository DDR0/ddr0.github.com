...
(function() {
  ...
  removeTile = function(x, y, qualifier, noRemoveDependants) {
    var tileList, tilesToRemove, tilesWithDependants, _base, _base1, _ref, _ref1;
    if (qualifier == null) {
      qualifier = '';
    }
    ...
    tileList = ((_ref = (_base = ((_ref1 = (_base1 = groundLayer.tiles)[x]) != null ? _ref1 : _base1[x] = []))[y]) != null ? _ref : _base[y] = []);
  ...
  removeBldg = function(x, y, qualifier) {
    var tileList, tilesToRemove, _base, _base1, _ref, _ref1;
    if (qualifier == null) {
      qualifier = '';
    }
    if (typeof qualifier === "function") {
    ...
    tileList = ((_ref = (_base = ((_ref1 = (_base1 = buildingLayer.tiles)[x]) != null ? _ref1 : _base1[x] = []))[y]) != null ? _ref : _base[y] = []);
    tilesToRemove = tileList.filter(function(tile) {
      return -1 < tile.type.indexOf(qualifier);
    });
    tileList = tileList.filter(function(tile) {
  ...
  printTile = function(x, y, qualifier) {
    var tileList, _base, _base1, _ref, _ref1;
    if (qualifier == null) {
      qualifier = '';
    }
    if (typeof qualifier === "function") {
  ...
  propertyGen = function(roadTiles, exNihilo) {
    ...
    validPropertyLocation = function(tile, index, tileList) {
      ...
      }))) && (exNihilo || !((_ref = (_base = ((_ref1 = (_base1 = groundLayer.tiles)[_name1 = tile.x]) != null ? _ref1 : _base1[_name1] = []))[_name = tile.y]) != null ? _ref : _base[_name] = []).length) && !(_.find(roadTiles, function(road) {
  ...
  registerEvents = function() {
    var _ref;
    ((_ref = window.city) != null ? _ref : window.city = {}).toggleVisibility = slideContentOut;
