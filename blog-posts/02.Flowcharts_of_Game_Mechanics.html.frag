...
<figure>
	<img alt='One relationship, here: time positively influences progress through the game.' src='~/Progress Quest.svg'>
...
<figure>
	<img alt='A complex graph of relationships in OpenTTD.' src='~/OpenTTD.svg'>
	<img src='~/Key.svg'>
...
<figure>
	<img alt='A simple graph of relationships in A Dark Room.' src='~/A Dark Room 1.svg'>
	<figcaption><strong>Stage 1</strong></figcaption>
</figure>
<figure>
	<img alt='A less simple graph.' src='~/A Dark Room 2.svg'>
	<figcaption><strong>Stage 2</strong></figcaption>
</figure>
<figure>
	<img alt='An even less simple graph.' src='~/A Dark Room 3.svg'>
	<figcaption><strong>Stage 3</strong></figcaption>
</figure>
<figure>
	<img alt='And so on.' src='~/A Dark Room 4.svg'>
	<!-- %img{:src => "~/Key.svg"} /Don't need this here 'cause it's been said already. -->
	<figcaption><strong>Stage 4</strong></figcaption>
</figure>
<p>
	And that – that is powerful stuff. <a class="external" href="https://www.valvesoftware.com/games/portal.html">Portal</a><a class='lp' href="https://www.youtube.com/watch?v=urlwUpCDLW4&list=SP28A9E697FB499C82&index=1"></a> (the first version, at least) played the same game, to great effect, and enjoyed great success. <em>Progress</em> is a powerful thing!
</p>
