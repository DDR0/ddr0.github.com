...
<iframe id="clouds-1" class="iframe-player" data-code-source="~/1-0 Clouds.html" width="300" height="150" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('clouds-1', '~/1-0 Clouds.html');">play</button>
...
<iframe id="clouds-2" class="iframe-player" data-code-source="~/1-1 Clouds.html" width="300" height="150" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		...
		<button onclick="createjsExamples.show('clouds-2', '~/1-1 Clouds.html');">code</button>
	</div>
...
<iframe id="clouds-3" class="iframe-player" data-code-source="~/1-2 Clouds.html" width="300" height="150" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('clouds-3', '~/1-2 Clouds.html');">play</button>
		<button onclick="createjsExamples.stop('clouds-3');">stop</button>
		<button onclick="createjsExamples.show('clouds-3', '~/1-2 Clouds.html');">code</button>
	</div>
...
<iframe id="mines-1" class="iframe-player" data-code-source="~/2-0 Minesweeper.html" width="320" height="320" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('mines-1', '~/2-0 Minesweeper.html');">play</button>
		<button onclick="createjsExamples.stop('mines-1');">stop</button>
		<button onclick="createjsExamples.show('mines-1', '~/2-0 Minesweeper.html');">code</button>
	</div>
...
<iframe id="mines-2" class="iframe-player" data-code-source="~/2-1 Minesweeper.html" width="320" height="320" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('mines-2', '~/2-1 Minesweeper.html');">play</button>
		<button onclick="createjsExamples.stop('mines-2');">stop</button>
		<button onclick="createjsExamples.show('mines-2', '~/2-1 Minesweeper.html');">code</button>
	</div>
...
<iframe id="mines-3" class="iframe-player" data-code-source="~/2-2 Minesweeper Remastered.html" width="320" height="320" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('mines-3', '~/2-2 Minesweeper Remastered.html');">play</button>
		<button onclick="createjsExamples.stop('mines-3');">stop</button>
		<button onclick="createjsExamples.show('mines-3', '~/2-2 Minesweeper Remastered.html');">code</button>
	</div>
<p>
...
<iframe id="resize-2" class="iframe-player" data-code-source="~/3-1 Resize.html" width="300" height="250" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('resize-2', '~/3-1 Resize.html');">play</button>
		<button onclick="createjsExamples.stop('resize-2');">stop</button>
		<button onclick="createjsExamples.show('resize-2', '~/3-1 Resize.html');">code</button>
	</div>
...
<iframe id="DOM-1" class="iframe-player" data-code-source="~/4-0 DOM Interface.html" width="300" height="200" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('DOM-1', '~/4-0 DOM Interface.html');">play</button>
		<button onclick="createjsExamples.stop('DOM-1');">stop</button>
		<button onclick="createjsExamples.show('DOM-1', '~/4-0 DOM Interface.html');">code</button>
	</div>
...
<iframe id="pixel-1" class="iframe-player" data-code-source="~/5-0 Pixel Effects.html" width="346" height="274" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('pixel-1', '~/5-0 Pixel Effects.html');">play</button>
		<button onclick="createjsExamples.stop('pixel-1');">stop</button>
		<button onclick="createjsExamples.show('pixel-1', '~/5-0 Pixel Effects.html');">code</button>
	</div>
...
<iframe id="pixel-2" class="iframe-player" data-code-source="~/5-1 Pixel Effects.html" width="346" height="274" scrolling="no"></iframe>
	<div class="iframe-player-buttons">
		<button onclick="createjsExamples.play('pixel-2', '~/5-1 Pixel Effects.html');">play</button>
		<button onclick="createjsExamples.stop('pixel-2');">stop</button>
		<button onclick="createjsExamples.show('pixel-2', '~/5-1 Pixel Effects.html');">code</button>
	</div>
