	...
	additionalHeadFields: [
		...
		`<script async type=module src="boloball/bolo-game.js"></script>`,
				...
				<section>
					...
					<h2>Skate. and FIFA 22</h2>
					<p>Skate. is EA's first social sandbox rooted in creativity and connection.</p>
					<p>I worked at Electronic Arts between 2021 and 2026. Initially, I worked on FIFA 22 as a UI engineer. Shortly after that released, I moved to Skate. where I worked on internal tools for that project.</p>
				</section>
				<hr>
